...
import HistoryPage from './HistoryPage'; // <-- 1. Import new history page
...
// This keeps the main render clean
const DashboardView = ({ rewardData }) => (
  <>
...
function ParentDashboard() {
  ...
  const [activeView, setActiveView] = useState('dashboard'); // <-- 2. State for view
  ...
  // --- 3. Helper to render the correct page ---
  const renderActiveView = () => {
    switch (activeView) {
      case 'dashboard':
        return <DashboardView rewardData={rewardData} />;
      case 'history':
        return <HistoryPage />;
      case 'settings':
  ...
  return (
    <div className="dashboard-container"> 
      {/* 4. Pass all state and setters to Sidebar */}
      <Sidebar 
      ...
      <div className="dashboard-content"> 
        ...
        {/* 5. Conditionally render the active view */}
